		...
		<View style={{ flex: 1, backgroundColor: Colors.background }}>
			...
			>
				...
				<GoalMenu goalId={goal.id} isIcon>
					<SymbolView
						name={{ ios: "ellipsis.circle", android: "more_vert", web: "more_horiz" }}
						size={24}
						tintColor={Colors.textPrimary}
						fallback={<Body style={{ color: Colors.textPrimary, fontSize: 20 }}>⋮</Body>}
					/>
				</GoalMenu>
			</View>
			...
			>
							...
							<View style={{ flexDirection: "row", alignItems: "center", gap: Spacing.lg }}>
								...
								<View style={{ flex: 1, gap: Spacing.xs }}>
									...
									<View style={{ flexDirection: "row", alignItems: "center", gap: Spacing.xs }}>
										<View style={{ width: 7, height: 7, borderRadius: 4, backgroundColor: goalColor }} />
				...
				<Animated.View entering={FadeInDown.duration(400).delay(80)}>
					<View style={{ flexDirection: "row", gap: Spacing.md } satisfies ViewStyle}>
						<StatCard label="30-Day Rate" value={`${thirtyDayRate}%`} color={goalColor} />
						<StatCard label="Check-ins" value={checkIns} color={goalColor} />
						<StatCard label="Best Streak" value={bestStreak} unit="d" color={goalColor} />
					</View>
				</Animated.View>
				...
				{/* ── Habits ────────────────────────────────────────── */}
				<Animated.View entering={FadeInDown.duration(400).delay(320)} style={{ gap: Spacing.md }}>
					<View
						style={{
							flexDirection: "row",
							justifyContent: "space-between",
					...
					>
						<Body
							weight="bold"
							size="sm"
							style={{ textTransform: "uppercase", letterSpacing: 1, color: Colors.textSecondary }}
						>
						...
						<Button
							...
							size="sm"
							onPress={() =>
								router.push({ pathname: "/add-habit", params: { goalId: goal.id } } as any)
							}
						/>
					</View>
